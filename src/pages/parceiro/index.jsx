      ...
      <>
        ...
        <form onSubmit={onSubmit} className='formCard'>
                <div className='cardTop'>
                    ...
                    <input type="number" id="cpf" name="cpf" onChange={onChange} minlength="11"/> <br></br>

                    <label className='labelStyle' htmlFor="telefone">TELEFONE</label><br></br>
                    <input type="number" id="telefone" name="telefone" onChange={onChange} minlength="10"/> <br></br>
                    ...
                    <input type="number" id="cnpj" name="cnpj" onChange={onChange} minlength="14"/> <br></br>

                    <label className='labelStyle' htmlFor="telefoneEmpresa">TELEFONE CORPORATIVO</label><br></br>
                    <input type="number" id="telefoneEmpresa" name="telefoneEmpresa" onChange={onChange} minlength="10"/> <br></br>
